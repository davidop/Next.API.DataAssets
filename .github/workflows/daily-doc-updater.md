...
- **Features Added**: New functionality, endpoints, configuration options, or capabilities
...
1. **Determine the correct file** based on the feature type:
   ...
   - Deployment changes → `docs/deploy/`
   - Compatibility information → `docs/compatibility/`
